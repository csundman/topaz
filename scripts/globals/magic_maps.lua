...
local blockMap = { --Maps that are blocked from purchasing
	[tpz.ki.MAP_OF_THE_NORTHLANDS_AREA] = 1,
	[tpz.ki.MAP_OF_KING_RANPERRES_TOMB] = 1, 
	[tpz.ki.MAP_OF_THE_DANGRUF_WADI] = 1, 
	[tpz.ki.MAP_OF_THE_HORUTOTO_RUINS] = 1, 
	[tpz.ki.MAP_OF_BOSTAUNIEUX_OUBLIETTE] = 1,
    [tpz.ki.MAP_OF_THE_TORAIMARAI_CANAL] = 1,
	[tpz.ki.MAP_OF_THE_GUSGEN_MINES] = 1, 
	[tpz.ki.MAP_OF_THE_CRAWLERS_NEST] = 1, 
	[tpz.ki.MAP_OF_THE_RANGUEMONT_PASS] = 1, 
	[tpz.ki.MAP_OF_DELKFUTTS_TOWER] = 1, 
	[tpz.ki.MAP_OF_FEIYIN] = 1, 
	[tpz.ki.MAP_OF_CASTLE_ZVAHL] = 1, 
	[tpz.ki.MAP_OF_THE_KUZOTZ_REGION] = 1,
    [tpz.ki.MAP_OF_THE_RUAUN_GARDENS] = 1, 
	[tpz.ki.MAP_OF_NORG] = 1,
	[tpz.ki.MAP_OF_THE_TEMPLE_OF_UGGALEPIH] = 1, 
	[tpz.ki.MAP_OF_THE_DEN_OF_RANCOR] = 1, 
	[tpz.ki.MAP_OF_THE_KUFTAL_TUNNEL] = 1, 
	[tpz.ki.MAP_OF_THE_BOYAHDA_TREE] = 1,
	[tpz.ki.MAP_OF_THE_VELUGANNON_PALACE] = 1,
    [tpz.ki.MAP_OF_IFRITS_CAULDRON] = 1, 
	[tpz.ki.MAP_OF_THE_QUICKSAND_CAVES] = 1,
	[tpz.ki.MAP_OF_THE_SEA_SERPENT_GROTTO] = 1,
	[tpz.ki.MAP_OF_THE_LABYRINTH_OF_ONZOZO] = 1, 
	[tpz.ki.MAP_OF_THE_ULEGUERAND_RANGE] = 1, 
	[tpz.ki.MAP_OF_THE_ATTOHWA_CHASM] = 1, 
	[tpz.ki.MAP_OF_PSOXJA] = 1,
    [tpz.ki.MAP_OF_OLDTON_MOVALPOLOS] = 1, 
	[tpz.ki.MAP_OF_NEWTON_MOVALPOLOS] = 1,
	[tpz.ki.MAP_OF_TAVNAZIA] = 1, 
	[tpz.ki.MAP_OF_THE_AQUEDUCTS] = 1, 
	[tpz.ki.MAP_OF_THE_SACRARIUM] = 1, 
	[tpz.ki.MAP_OF_CAPE_RIVERNE] = 1, 
	[tpz.ki.MAP_OF_ALTAIEU] = 1, 
	[tpz.ki.MAP_OF_HUXZOI] = 1, 
	[tpz.ki.MAP_OF_RUHMET] = 1,
	[tpz.ki.MAP_OF_CAEDARVA_MIRE] = 1, 
	[tpz.ki.MAP_OF_MOUNT_ZHAYOLM] = 1, 
	[tpz.ki.MAP_OF_AYDEEWA_SUBTERRANE] = 1, 
	[tpz.ki.MAP_OF_MAMOOK] = 1, 
	[tpz.ki.MAP_OF_HALVUNG] = 1, 
	[tpz.ki.MAP_OF_ALZADAAL_RUINS] = 1,
    [tpz.ki.MAP_OF_VUNKERL_INLET] = 1, 
	[tpz.ki.MAP_OF_GRAUBERG] = 1, 
	[tpz.ki.MAP_OF_FORT_KARUGONARUGO] = 1
}
